$(function(){
	...
	function left_slide_circle(){
		...
		$('.slide-stage1').css("left",-image_width + "px"); // Dịch chuyển tức thời vị trí của stage sang một khoảng bằng 1 slide-image
	...
	function right_slide_circle(){
		...
		$('.slide-stage1').css("left",-(stage_width - image_width - display_width) + "px"); // Dịch chuyển tức thời vị trí của stage sang một khoảng bằng 1 slide-image
